...
import { AutocompletarCid, Botao, BotaoExcluir, Card, Input } from "./index";
            ...
            <div className="col-lg-12">
                ...
                <Card className={"collapsed-card"} titulo={"CID"} botaoMin>
                    ...
                    <FormGroup>
                        <div className={"col-lg-12"}>
                            {cids.map((cid, index) => (
                                <FormGroup key={index} className={"col-lg-3"} style={{display: "inline-flex"}}>
                ...
                <Botao style={{marginLeft: '1037px'}} cor={props.corDoBotao} icone={props.icone} onClick={() => handleBtnFinalizarConsulta(props.idConsulta, Number("7"), props.cids)}>{props.nome}</Botao>
            </div>
        </div>
    )
};
